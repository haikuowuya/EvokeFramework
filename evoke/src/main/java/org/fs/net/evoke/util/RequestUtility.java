...
public class RequestUtility {
    ...
    private RequestUtility() { /*private constructor.*/ }
            ...
            if(!StringUtility.isNullOrEmpty(baseUrl)) {
                ...
                for(String key : params.keySet()) {
                    ...
                    if(StringUtility.isNullOrEmpty(value)) {
                        ...
                        builder = addQueryParameter(builder, key, value);
                    }
                }
     ...
     * @return
     */
    static Uri.Builder addQueryParameter(Uri.Builder builder, String key, String value) {
        if(builder != null) {
     ...
     * don't forget to pass charset as charset=utf-8
     *
     * @param rawPost
     * @param mime
     * @return
